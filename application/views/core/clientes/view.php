        ...
        <form class="formClientes" id="formClientes">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <select class="form-control select2 select2-hidden-accesible habilitar requerido" name="ticl_id" id="ticl_id" style="width: 100%;">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <select class="form-control s2MdlAgregar select2-hidden-accesible requerido disabled" name="ticl_id" id="ticl_id_edit" style="width: 100%;">	
                                                <?php
                                                    foreach ($tipos_clientes as $tipos) {
                                                    echo '<option  value="'.$tipos->tabl_id.'">'.$tipos->valor.'</option>';
                                                    }
