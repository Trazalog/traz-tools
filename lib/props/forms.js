...
function fillForm(data, form = false){
  Object.keys(data).forEach(e => {
      ...
      switch (obj.getAttribute('type')) {
		  ...
		  case 'file':
			  $(obj).addClass('hidden');
			  $(obj).closest('.form-group').find('.help-block').html(`<a href='${data[e]}'>Click para descargar</a>`);
          break;
...
function previewFile(e) {
    var idImagen = $(e).attr('id');
    var preview = document.querySelector('#vistaPrevia_'+idImagen);
