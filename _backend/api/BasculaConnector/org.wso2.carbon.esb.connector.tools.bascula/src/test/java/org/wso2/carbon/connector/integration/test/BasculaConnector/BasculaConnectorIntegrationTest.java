...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.BasculaConnector;
 ...
 */
public class BasculaConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "BasculaConnector test case")
